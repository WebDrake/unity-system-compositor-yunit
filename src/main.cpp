...
try
{
    ...
    auto version_flag = pre_init(miral::CommandLineOption(
        [](bool is_set)
        {
            if (is_set)
            {
    ...
    auto public_socket_flag = pre_init(miral::CommandLineOption(
        [&](bool is_set)
        {
    ...
    auto spinner_flag = pre_init(miral::CommandLineOption(
    ...
    auto enable_hardware_cursor_flag = pre_init(miral::CommandLineOption(
        [&](bool is_set)
        {
